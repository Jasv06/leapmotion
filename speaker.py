...
sys.path.insert(0,"PATH OF FILE")
...
rospy.loginfo("Parameter set on server:".format(rospy.get_param(PARAMNAME_FREQ_ENTIRE, FREQUENCY_ROSTOPIC_DEFAULT)))
...
while not rospy.is_shutdown():
     ...
     fingerPointNames = ['metacarpal', 'proximal','intermediate', 'distal', 'tip']
